...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Full-Stack Engineer</span> <span className="text-primary/60">✦</span>
    <span>AI / ML Systems</span> <span className="text-secondary/60">✦</span>
    <span>Production-Grade Code</span> <span className="text-primary/60">✦</span>
    <span>Next.js · FastAPI · Python</span> <span className="text-secondary/60">✦</span>
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton as="a" href="mailto:omprakashsamal75@gmail.com" className="footer-glass-pill px-10 py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group">
                ...
                <MagneticButton as="a" href="https://github.com/omprakash0224" target="_blank" rel="noopener noreferrer" className="footer-glass-pill px-10 py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                <MagneticButton as="a" href="https://www.linkedin.com/in/iamomprakashsamal/" target="_blank" rel="noopener noreferrer" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground">
                  LinkedIn
                </MagneticButton>
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © 2026 Om Prakash Samal. All rights reserved.
            </div>
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-border/50">
              ...
              <span className="text-foreground font-black text-xs md:text-sm tracking-normal ml-1">Om Prakash</span>
            </div>
